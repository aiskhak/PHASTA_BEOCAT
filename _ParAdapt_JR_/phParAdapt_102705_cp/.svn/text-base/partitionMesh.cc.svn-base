...
int partitionMesh(pParMesh pmesh)
{
  ...
  if(justpart == 1){
      if(PMU_rank()==0){
          ...
          while (gface[0] = GFIter_next(gfiter))
              if (GEN_dataI((pGEntity)gface[0],"intr")) break;// interior model face

          GFIter_reset(gfiter);
          
          while (gface[1] = GFIter_next(gfiter))  {
              if (!GEN_dataI((pGEntity)gface[1],"intr"))// interior model face
                  if(GEN_dataI((pGEntity)gface[1],"sper")) break;//SPEBC
          }
  ...
  // on 0  procs if in  1stage - mesh is NOT parted
      ...
      if(PMU_rank()==0){
          ...
          while (gface[0] = GFIter_next(gfiter))
              if (GEN_dataI((pGEntity)gface[0],"intr")) break;
          
          GFIter_reset(gfiter);
          
          while (gface[1] = GFIter_next(gfiter))  {
              if (!GEN_dataI((pGEntity)gface[1],"intr"))
                  if(GEN_dataI((pGEntity)gface[1],"sper")) break;
          }
