...
#ifdef PARALLEL
void setup(pParMesh pmesh, globalInfo *info);
...
void writeEnsaFiles(pParMesh pmesh, globalInfo *info, pPList bdry);
...
void restart(double* q, int nshgTot, int nshgReqst, int nvReqst, int* lstep, pMesh mesh);
