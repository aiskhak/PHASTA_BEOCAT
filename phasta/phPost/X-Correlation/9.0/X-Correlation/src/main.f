...
c**************************************************************
      ...
      write (fmt6,"('(''Xcorrelation.'',i',i1,',1x)')") itmp6
      write (fname6,fmt6) t  
      fname6 = trim(fname6)
...
c***************************************************************
      ...
      write (fmt5,"('(''Xcorrelation.'',i',i1,',1x)')") itmp
      write (fname5,fmt5) t
      fname5 = trim(fname5)
      open (unit=600, file=fname5, status='unknown' )
         ...
         do i = 1, nx+1
          ...
          read(600,999) dd,CorrUU(i),CorrVV(i),CorrWW(i)               
...
c**************************************************************
           ...
           do i = 1, nx+1
              ...
              sumRuu(i) = sumRuu(i) + CorrUU(i)
              sumRvv(i) = sumRvv(i) + CorrVV(i)
              sumRww(i) = sumRww(i) + CorrWW(i)
...
c**************************************************************
         WRITE(*,*)" Writing Final X-Correlation file "
         WRITE(*,*)" "
     ...
     &     itmpF,itmpL
      ...
      do i = 1,nx+1
         ...
         write(700,999) dx(i),sumRuu(i),sumRvv(i),sumRww(i)
...
c**************************************************************
         WRITE(*,*)" Writing Final X-Correlation Normalized file "
         WRITE(*,*)" "
     ...
     &     itmpFN,itmpLN
      ...
      do i = 1,nx+1
         ...
         write(800,999) dx(i),sumRuu(i),sumRvv(i),sumRww(i)
