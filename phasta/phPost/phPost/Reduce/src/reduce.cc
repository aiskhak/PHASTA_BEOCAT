...
int main(int argc, char* argv[]){
    ...
    if (RequestedSolution) {
        ...
        iarray[0] = -1;
	readheader_(&irstin,"solution",(void*)iarray,&ithree,"double",iotype);
	if(iarray[0]==-1){
    ...
    if (RequestedBoundaryFluxes) {
        ...
        openfile_(rfname, "read", &irstin   );
        iarray[0] = -1;
        readheader_(&irstin,"boundary flux",(void*)iarray,&ithree,"double",iotype);
	if(iarray[0]==-1){
    ...
    if (RequestedTurbStats) {
        ...
        openfile_(rfname, "read", &irstin   );
        iarray[0] = -1;
        readheader_(&irstin,"statistics",(void*)iarray,&ifive,"double",iotype);
	if(iarray[0]==-1){
    ...
    if (RequestedErrors) {
        ...
        openfile_(rfname, "read", &irstin   );
        iarray[0] = -1;
	readheader_(&irstin,fieldname,(void*)iarray,&ithree,"double",iotype);
	if(iarray[0]==-1){
    ...
    if (RequestedVelbar) {
        ...
        openfile_(rfname, "read", &irstin   );
        iarray[0] = -1;
	readheader_(&irstin,"velbar",(void*)iarray,&ithree,"double",iotype);
	if(iarray[0]==-1){
    ...
    if (RequestedWSS) {
        ...
        openfile_(rfname, "read", &irstin   );
        iarray[0] = -1;
	readheader_(&irstin,"wall shear stresses",(void*)iarray,&ithree,"double",iotype);
	if(iarray[0]==-1){
	...
	if(RequestedSolution){
        ...
        if(RequestedAcceleration){
            ...
            printf("Reducing : %s \n", rfname);
            openfile_(rfname, "read", &irstin   );
            readheader_(&irstin,"time derivative of solution",(void*)iarray,&ithree,"double",iotype);
            nshgl=iarray[0];
            numvar=iarray[1];
            lstep=iarray[2];
            iqsiz=nshgl*numvar;
	    ...
	    nTimeStep = iarray[4];
            iqsiz=nshgl*numvar;
            readdatablock_(&irstin,"statistics",(void*)qlocal,&iqsiz, "double", iotype);
            closefile_(&irstin, "read");
	...
	if(RequestedErrors){
            ...
            lstep=iarray[2];
            iqsiz=nshgl*numvar;
            readdatablock_(&irstin,fieldname,(void*)qlocal, &iqsiz, "double", iotype);
            closefile_( &irstin, "read" ); 
	...
	if(RequestedVelbar){
            ...
            lstep=iarray[2];
            iqsiz=nshgl*numvar;
            readdatablock_(&irstin,"velbar",(void*)qlocal, &iqsiz, "double", iotype);
            closefile_( &irstin, "read" ); 
