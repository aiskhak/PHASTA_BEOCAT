...
void phastaOutput(int* array, double* qglobal, double* aglobal, 
	...
	i=-1;
        ...
        if ( sms2edge ) {
            ...
            iarray[1]=emodes;
            nitems=2;
            writeheader_( &irstin, "edge mode mapping to sms", (void*)iarray, &nitems, &esize,"integer", iotype);
            writedatablock_( &irstin, "edge mode mapping to sms", (void*)(sms2edge), &esize, "integer", iotype );
            delete [] sms2edge;
        }
        if ( sms2face ) {
            iarray[0]=fsize;
            iarray[1]=fmodes;
            nitems=2;
            writeheader_( &irstin, "face mode mapping to sms", (void*)iarray, &nitems, &fsize,"integer", iotype);
            writedatablock_( &irstin, "face mode mapping to sms", (void*)(sms2face), &fsize, "integer", iotype );
            delete [] sms2face;
        }
        ...
        writeheader_( &irstin, "boundary flux ",
                  (void*)iarray, &nitems, &size,"double", iotype);
      
        nitems = numvar*nshgtot;
        writedatablock_( &irstin, "boundary flux ",
                     (void*)(qglobal), &nitems, "double", iotype );
	...
	iarray[4] = nTimeStep;
        ...
        writeheader_( &irstin, fieldname,
                  (void*)iarray, &nitems, &size,"double", iotype);
      
        nitems = numvar*nshgtot;
        writedatablock_( &irstin, fieldname,
                     (void*)(qglobal), &nitems, "double", iotype );
        ...
        writeheader_( &irstin, "velbar ",
                  (void*)iarray, &nitems, &size,"double", iotype);
      
        nitems = numvar*nshgtot;
        writedatablock_( &irstin, "velbar ",
                     (void*)(qglobal), &nitems, "double", iotype );
