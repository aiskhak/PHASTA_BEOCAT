...
// Igor, 08/2012: directory structure for restarts (important for NumProcs > ~20000 ?)
    ...
    readheader_( &igeombc, "number of interior elements", (void*)iarray, 
...
// -------------------------
    ...
    if ( SONFATH_VAR > 0 ) {
        ...
        sonfath_( ncvec, vnumnp, ifath, nsons, 
    ...
    if(iarray[0]==-1) accelexist = 0;
        ...
        readdatablock_( &irestart,"time derivative of solution?", (void*)acceleration, &isize, 
                        "double", iformat  ); 
    }
