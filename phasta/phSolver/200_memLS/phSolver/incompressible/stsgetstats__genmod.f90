        ...
        MODULE STSGETSTATS__genmod
          INTERFACE 
            SUBROUTINE STSGETSTATS(Y,YOLD,AC,ACOLD,U,UOLD,X,SHP,SHGL,   &
     &SHPB,SHGLB,IBC,BC,IPER,ILWORK,ROWP,COLM,LHSK,LHSP)
              USE STATS
     ...
     &,NNZ,ISTOP,NFLOW,NNZ_TOT,IDTN
              ...
              REAL(KIND=8) :: YOLD(NSHG,NDOF)
              REAL(KIND=8) :: AC(NSHG,NDOF)
              REAL(KIND=8) :: ACOLD(NSHG,NDOF)
              REAL(KIND=8) :: U(NSHG,3)
              REAL(KIND=8) :: UOLD(NSHG,3)
              ...
              INTEGER(KIND=4) :: ROWP(NSHG*NNZ)
              INTEGER(KIND=4) :: COLM(NSHG+1)
              REAL(KIND=8) :: LHSK(9,NNZ_TOT)
              REAL(KIND=8) :: LHSP(4,NNZ_TOT)
            END SUBROUTINE STSGETSTATS
          END INTERFACE 
        END MODULE STSGETSTATS__genmod
