        !COMPILER-GENERATED INTERFACE MODULE: Fri Jul 11 21:31:35 2025
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE DFWRSFDMC__genmod
          INTERFACE 
            SUBROUTINE DFWRSFDMC(Y,SHGL,SHP,IPER,ILWORK,NSONS,IFATH,X,  &
     &FWR2,FWR3)
     ...
     &,NNZ,ISTOP,NFLOW,NNZ_TOT,IDTN
              ...
              REAL(KIND=8) :: FWR2(NSHG)
              REAL(KIND=8) :: FWR3(NSHG)
            END SUBROUTINE DFWRSFDMC
          END INTERFACE 
        END MODULE DFWRSFDMC__genmod
