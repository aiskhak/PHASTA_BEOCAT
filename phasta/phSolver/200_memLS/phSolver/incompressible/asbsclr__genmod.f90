        ...
        MODULE ASBSCLR__genmod
          INTERFACE 
            SUBROUTINE ASBSCLR(Y,X,SHPB,SHGLB,IENB,MATERB,IBCB,BCB,RES)
     ...
     &NDOFL,NSYMDL,NENL,NFACEL,NENBL,INTIND,MATTYP
              ...
              REAL(KIND=8) :: SHPB(NSHL,*)
              REAL(KIND=8) :: SHGLB(3,NSHL,*)
            ...
            END SUBROUTINE ASBSCLR
          END INTERFACE 
        END MODULE ASBSCLR__genmod
