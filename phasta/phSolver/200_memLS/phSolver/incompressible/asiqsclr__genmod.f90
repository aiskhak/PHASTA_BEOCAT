        ...
        MODULE ASIQSCLR__genmod
          INTERFACE 
            SUBROUTINE ASIQSCLR(Y,X,SHP,SHGL,IEN,QRES,RMASS,CFL,ICFLHITS&
     &)
     ...
     &NDOFL,NSYMDL,NENL,NFACEL,NENBL,INTIND,MATTYP
              ...
              REAL(KIND=8) :: QRES(NSHG,3)
              REAL(KIND=8) :: RMASS(NSHG)
              REAL(KIND=8) :: CFL(NSHG)
              INTEGER(KIND=4) :: ICFLHITS(NSHG)
            END SUBROUTINE ASIQSCLR
          END INTERFACE 
        END MODULE ASIQSCLR__genmod
