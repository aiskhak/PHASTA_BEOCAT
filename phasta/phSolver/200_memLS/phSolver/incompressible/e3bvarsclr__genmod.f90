        ...
        MODULE E3BVARSCLR__genmod
          INTERFACE 
            SUBROUTINE E3BVARSCLR(YL,SHDRV,XLB,SHAPE,WDETJB,BNORM,FLUX, &
     &DWL,EVL)
              COMMON/PROPAR/ NPRO
                INTEGER(KIND=4) :: NPRO
     ...
     &NDOFL,NSYMDL,NENL,NFACEL,NENBL,INTIND,MATTYP
              ...
              REAL(KIND=8) :: FLUX(NPRO)
              REAL(KIND=8) :: DWL(NPRO,NSHL)
              REAL(KIND=8) :: EVL(NPRO,NSHL)
            END SUBROUTINE E3BVARSCLR
          END INTERFACE 
        END MODULE E3BVARSCLR__genmod
