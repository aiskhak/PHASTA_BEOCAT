...
c
        ...
        call localSum (cflbuint, cflbuintl, ien, icflbuinthits, 1)
c
c!.... end
c
        if (exts) then
...
c!	Two-phase flows averaging:
           if (numvar.ge.15) then
              call timeseries(yl(:,:,6),xl,ien,sgn,15,15)  !origrinally 6
            endif
