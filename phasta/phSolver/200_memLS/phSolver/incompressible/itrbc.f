...
c
        ...
        subroutine itrBCSclr (y, ac, iBC, BC, iper, ilwork,banma)
c
c----------------------------------------------------------------------
c
...
c
!        do i = 1, nshg
!          if(BC(i,2).ne.0.0d0.and.BC(i,2).ne.370.15d0)
!     &      write(*,*)'i,BC',i,BC(i,2)
!        enddo
...
!       endif
c      if(myrank.eq.master)write(*,*)'T_sat',T_sat
