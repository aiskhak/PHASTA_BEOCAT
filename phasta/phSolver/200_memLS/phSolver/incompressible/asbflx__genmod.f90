        !COMPILER-GENERATED INTERFACE MODULE: Fri Jul 11 21:31:24 2025
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE ASBFLX__genmod
          INTERFACE 
            SUBROUTINE ASBFLX(U,Y,AC,X,SHPB,SHGLB,IENB,IBCB,BCB,INVFLX, &
     &FLXRES,FLXLHS,FLXNRM,XKEBE)
     ...
     &NDOFL,NSYMDL,NENL,NFACEL,NENBL,INTIND,MATTYP
              ...
              REAL(KIND=8) :: BCB(NPRO,NSHLB,NDBCB)
              INTEGER(KIND=4) :: INVFLX(NSHG)
              REAL(KIND=8) :: FLXRES(NSHG,NFLOW)
              REAL(KIND=8) :: FLXLHS(NSHG,1)
              REAL(KIND=8) :: FLXNRM(NSHG,3)
              REAL(KIND=8) :: XKEBE(NPRO,9,NSHL,NSHL)
            END SUBROUTINE ASBFLX
          END INTERFACE 
        END MODULE ASBFLX__genmod
