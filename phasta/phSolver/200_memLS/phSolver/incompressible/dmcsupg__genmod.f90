        ...
        MODULE DMCSUPG__genmod
          INTERFACE 
            SUBROUTINE DMCSUPG(Y,AC,SHGL,SHP,IPER,ILWORK,NSONS,IFATH,X, &
     &IBC,BC,ROWP,COLM,XAVEGT,STABDIS)
     ...
     &,NNZ,ISTOP,NFLOW,NNZ_TOT,IDTN
            ...
            END SUBROUTINE DMCSUPG
          END INTERFACE 
        END MODULE DMCSUPG__genmod
