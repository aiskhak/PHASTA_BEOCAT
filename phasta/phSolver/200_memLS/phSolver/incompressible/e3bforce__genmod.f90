        ...
        MODULE E3BFORCE__genmod
          INTERFACE 
            SUBROUTINE E3BFORCE(YL,IBCB,BCB,SHPB,SHGLB,XLB,SGN,YLOTWN,  &
     &EVL)
              COMMON/PROPAR/ NPRO
                INTEGER(KIND=4) :: NPRO
     ...
     &INTP,MAXNINT
              ...
              REAL(KIND=8) :: YLOTWN(NPRO,NSHL,NDOF)
              REAL(KIND=8) :: EVL(NPRO,NSHL)
            END SUBROUTINE E3BFORCE
          END INTERFACE 
        END MODULE E3BFORCE__genmod
