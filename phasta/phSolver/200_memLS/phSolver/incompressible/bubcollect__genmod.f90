        ...
        MODULE BUBCOLLECT__genmod
          INTERFACE 
            SUBROUTINE BUBCOLLECT(U1,U2,U3,SCLR,DIST2W,XX,YL,BML,       &
     &ELEMVOL_LOCAL,RHO,TEMPB,GYTEMP,CURVINFO,CANODE,CA_VECTOR)
              COMMON/PROPAR/ NPRO
                INTEGER(KIND=4) :: NPRO
     ...
     &,COALINVSIGMA,PRESAVG,ENTROPYPRESSURE
              ...
              REAL(KIND=8) :: TEMPB(NPRO)
              REAL(KIND=8) :: GYTEMP(NPRO,5)
              REAL(KIND=8) :: CURVINFO(NPRO)
              REAL(KIND=8) :: CANODE(IBKSIZ)
              REAL(KIND=8) :: CA_VECTOR(IBKSIZ)
            END SUBROUTINE BUBCOLLECT
          END INTERFACE 
        END MODULE BUBCOLLECT__genmod
