        !COMPILER-GENERATED INTERFACE MODULE: Fri Jul 11 21:31:38 2025
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE CPJDMCNOI__genmod
          INTERFACE 
            SUBROUTINE CPJDMCNOI(Y,SHGL,SHP,IPER,ILWORK,X,ROWP,COLM,IBC,&
     &BC)
     ...
     &,NNZ,ISTOP,NFLOW,NNZ_TOT,IDTN
            ...
            END SUBROUTINE CPJDMCNOI
          END INTERFACE 
        END MODULE CPJDMCNOI__genmod
