        !COMPILER-GENERATED INTERFACE MODULE: Fri Jul 11 21:31:25 2025
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE BC3DIAG__genmod
          INTERFACE 
     ...
     &,COALINVSIGMA,PRESAVG,ENTROPYPRESSURE
              ...
              REAL(KIND=8) :: RES(NSHG,4)
            END SUBROUTINE BC3DIAG
          END INTERFACE 
        END MODULE BC3DIAG__genmod
