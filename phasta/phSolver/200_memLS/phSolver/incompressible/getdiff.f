...
c         write(*,*)'rho,cp,k_T',rho,cp,k_T
!---------Thermal properties mixture for boiling-------------------------
         if (solheat.eq.1.0)then
           do i = 1, npro
!           epsilon_lst_tmp = epsilon_lst*elem_size(i)
           epsilon_lst_tmp = epsilon_lsd *
     &           elem_local_size(lcblk(1,iblk)+i-1)
...
!         diffus(:) = datmat(1,4,1)/datmat(1,3,1)
!          diffus(:) = datmat(1,4,1)
!        write(*,*)'diffus',diffus
