        ...
        MODULE E3__genmod
          INTERFACE 
            SUBROUTINE E3(YL,ACL,DWL,SHP,SHGL,XL,RL,QL,XKEBE,XGOC,XMUDMI&
     &,SGN,RERRL,RLSL,CFLL,EVL,XWL,YWL,ZWL,ELEMVOL_LOCAL,CFLBUINTL,     &
     &XARRAY,YARRAY,ZARRAY,BUBRADIUS,BUBRADIUS2,COORDTAG,BML)
              COMMON/PROPAR/ NPRO
                INTEGER(KIND=4) :: NPRO
     ...
     &,COALINVSIGMA,PRESAVG,ENTROPYPRESSURE
              ...
              REAL(KIND=8) :: RL(NPRO,NSHL,NFLOW)
              ...
              REAL(KIND=8) :: CFLBUINTL(NPRO,NSHL)
