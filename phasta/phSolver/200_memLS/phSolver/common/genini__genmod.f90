        ...
        MODULE GENINI__genmod
          INTERFACE 
            SUBROUTINE GENINI(IBC,BC,Y,AC,BANMA,IPER,ILWORK,IFATH,VELBAR&
     &,NSONS,X,SHP,SHGL,SHPB,SHGLB)
     ...
     &,NNZ,ISTOP,NFLOW,NNZ_TOT,IDTN
            ...
            END SUBROUTINE GENINI
          END INTERFACE 
        END MODULE GENINI__genmod
