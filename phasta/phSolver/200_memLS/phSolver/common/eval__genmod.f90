        ...
        MODULE EVAL__genmod
          INTERFACE 
            SUBROUTINE EVAL(XL,YCL,YVL,SHP,SHGL,SGN,NVARS,NPTS)
              COMMON/PROPAR/ NPRO
                INTEGER(KIND=4) :: NPRO
     ...
     &NDOFL,NSYMDL,NENL,NFACEL,NENBL,INTIND,MATTYP
              ...
              REAL(KIND=8) :: YCL(NPRO,NSHL,NDOF)
              REAL(KIND=8) :: YVL(NPRO,NSHL,NVARS)
              REAL(KIND=8) :: SHP(NSHL,NPTS)
              REAL(KIND=8) :: SHGL(3,NSHL,NPTS)
              REAL(KIND=8) :: SGN(NPRO,NSHL)
            END SUBROUTINE EVAL
          END INTERFACE 
        END MODULE EVAL__genmod
