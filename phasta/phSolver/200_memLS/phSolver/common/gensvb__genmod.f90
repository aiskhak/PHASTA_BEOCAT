        ...
        MODULE GENSVB__genmod
          INTERFACE 
            SUBROUTINE GENSVB(IENTMP,IBCBTMP,BCBTMP,MATTMP,IENB,IBCB,BCB&
     &,MATERB)
              COMMON/PROPAR/ NPRO
                INTEGER(KIND=4) :: NPRO
     ...
     &NTOPSH,NSONMAX
              ...
              INTEGER(KIND=4) :: IBCBTMP(NPRO,NDIBCB)
              REAL(KIND=8) :: BCBTMP(NPRO,NDBCB)
              INTEGER(KIND=4) :: MATTMP(NPRO)
              INTEGER(KIND=4) :: IENB(NPRO,NSHL)
              INTEGER(KIND=4) :: IBCB(NPRO,NDIBCB)
              REAL(KIND=8) :: BCB(NPRO,NSHLB,NDBCB)
              INTEGER(KIND=4) :: MATERB(NPRO)
            END SUBROUTINE GENSVB
          END INTERFACE 
        END MODULE GENSVB__genmod
