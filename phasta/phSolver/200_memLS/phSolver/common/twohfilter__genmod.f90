        ...
        MODULE TWOHFILTER__genmod
          INTERFACE 
            SUBROUTINE TWOHFILTER(Y,X,STRNRM,IEN,FRES,HFRES,SHGL,SHP,   &
     &QWTF)
              COMMON/PROPAR/ NPRO
                INTEGER(KIND=4) :: NPRO
     ...
     &DKE,FWR1,FLUMP,IERRCALC,IHESSIAN,ITWMOD,NGAUSSF,IDIM,NLIST,NINTF
              ...
              REAL(KIND=8) :: STRNRM(NPRO,NGAUSS)
              INTEGER(KIND=4) :: IEN(NPRO,NSHL)
              REAL(KIND=8) :: FRES(NSHG,33)
              REAL(KIND=8) :: HFRES(NSHG,11)
              REAL(KIND=8) :: SHGL(3,NSHL,32)
              REAL(KIND=8) :: SHP(NSHL,32)
              REAL(KIND=8) :: QWTF(NGAUSSF)
            END SUBROUTINE TWOHFILTER
          END INTERFACE 
        END MODULE TWOHFILTER__genmod
