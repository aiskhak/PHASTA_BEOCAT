        !COMPILER-GENERATED INTERFACE MODULE: Fri Jul 11 21:31:10 2025
        ! This source file is for reference only and may not completely
        ! represent the generated interface used by the compiler.
        MODULE FILLSPARSEI__genmod
          INTERFACE 
            SUBROUTINE FILLSPARSEI(IENS,XKEBE,LHSK,XGOC,LHSP,ROW,COL)
              COMMON/PROPAR/ NPRO
                INTEGER(KIND=4) :: NPRO
     ...
     &,NNZ,ISTOP,NFLOW,NNZ_TOT,IDTN
              ...
              INTEGER(KIND=4) :: ROW(NSHG*NNZ)
              INTEGER(KIND=4) :: COL(NSHG+1)
            END SUBROUTINE FILLSPARSEI
          END INTERFACE 
        END MODULE FILLSPARSEI__genmod
