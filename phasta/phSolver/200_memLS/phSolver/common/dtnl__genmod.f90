     ...
     &CONSRV_SCLR_CONV_VEL
                REAL(KIND=8) :: SCDIFF(5)
                REAL(KIND=8) :: TDECAY
                INTEGER(KIND=4) :: NSCLR
                INTEGER(KIND=4) :: ISCLR
                INTEGER(KIND=4) :: NSOLT
                INTEGER(KIND=4) :: NOSOURCE
                INTEGER(KIND=4) :: CONSRV_SCLR_CONV_VEL
