        ...
        MODULE VOLCON__genmod
          INTERFACE 
            SUBROUTINE VOLCON(Y,X,SHP,SHGL,IEN,RMASS,V_LAMBDA1,HPRIME,  &
     &V_LAMBDA2)
     ...
     &NTOPSH,NSONMAX
              ...
              REAL(KIND=8) :: V_LAMBDA1(NSHG)
              REAL(KIND=8) :: HPRIME(NSHG)
              REAL(KIND=8) :: V_LAMBDA2(NSHG)
            END SUBROUTINE VOLCON
          END INTERFACE 
        END MODULE VOLCON__genmod
