        ...
        MODULE FILLSPARSESCLR__genmod
          INTERFACE 
            SUBROUTINE FILLSPARSESCLR(IENS,XSEBE,LHSS,ROW,COL)
              COMMON/PROPAR/ NPRO
                INTEGER(KIND=4) :: NPRO
     ...
     &,NNZ,ISTOP,NFLOW,NNZ_TOT,IDTN
              ...
              REAL(KIND=8) :: LHSS(NNZ_TOT)
              INTEGER(KIND=4) :: ROW(NSHG*NNZ)
              INTEGER(KIND=4) :: COL(NSHG+1)
            END SUBROUTINE FILLSPARSESCLR
          END INTERFACE 
        END MODULE FILLSPARSESCLR__genmod
