     ...
     &NTOPSH,NSONMAX
              ...
              INTEGER(KIND=4) :: N
              INTEGER(KIND=4) :: GLOBALIBC(NSHG,N)
              REAL(KIND=8) :: GLOBALBC(NSHG,N)
              INTEGER(KIND=4) :: RLOCALIBC(NPRO,NSHL,N)
              REAL(KIND=8) :: RLOCALBC(NPRO,NSHL,N)
              INTEGER(KIND=4) :: IENTMP(NPRO,NSHL)
              CHARACTER(LEN=8) :: CODE
            END SUBROUTINE LOCALBC
          END INTERFACE 
        END MODULE LOCALBC__genmod
